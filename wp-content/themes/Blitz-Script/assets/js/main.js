...
/* harmony import */ var _modules_scrollToTop__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/scrollToTop */ "./src/js/modules/scrollToTop.js");
/* harmony import */ var _modules_select_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/select.js */ "./src/js/modules/select.js");
 // Аккордион
...
Object(_modules_scrollToTop__WEBPACK_IMPORTED_MODULE_4__["default"])();
Object(_modules_select_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
      ...
      if (document.querySelector(this.accordion)) {
        ...
        if (document.querySelectorAll(this.accordItems).length > 1) {
          if (t = document.querySelectorAll(this.accordItems), i = document.querySelectorAll(this.accordItemsContent), this.options.initialActiveItem && this.options.initialActiveItemIndex) {
            if ("number" == typeof this.options.initialActiveItemIndex && (i[this.options.initialActiveItemIndex].classList.add(this.activeContentClass), i[this.options.initialActiveItemIndex].style.height = i[this.options.initialActiveItemIndex].scrollHeight + "px", t[this.options.initialActiveItemIndex].classList.add(this.activeTitleClass)), Array.isArray(this.options.initialActiveItemIndex)) for (var s = 0; s < this.options.initialActiveItemIndex.length; s++) {
              i[this.options.initialActiveItemIndex[s]].classList.add(this.activeContentClass), i[this.options.initialActiveItemIndex[s]].style.height = i[this.options.initialActiveItemIndex[s]].scrollHeight + "px", t[this.options.initialActiveItemIndex[s]].classList.add(this.activeTitleClass);
            }
...
function accordion() {
  var accordion = new _libs_accordion_plagin_min_js__WEBPACK_IMPORTED_MODULE_0__["default"]('.accordion', '.accordion .accordion-block', '.accordion .accordion-block__box', 'active', 'active', {
...
function modal() {
  if (document.querySelector('.overlay')) {
    var popupBg = document.querySelector('.overlay'); // Фон попап окна

    var popup = document.querySelector('.modal'); // Само окно

    var popup2 = document.querySelector('.modal2'); // Само окно

    var openPopupButtons = document.querySelectorAll('.open-modal'); // Кнопки для показа окна

    var openPopupButtons2 = document.querySelectorAll('.open-modal2'); // Кнопки для показа окна

    var closePopupButton = document.querySelectorAll('.close-modal'); // Кнопка для скрытия окна
    ...
    window.addEventListener('keydown', function (e) {
      if (e.code === 'Escape') {
        if (document.querySelector('.modal' || false)) {
          setTimeout(function () {
            body.classList.remove('no-scroll');
            popupBg.classList.remove('active'); // Убираем активный класс с фона
...
function scrollToTop() {
  ...
  function getWindowScrollTop() {
    if (window.pageYOffset >= 300) {
      // Расстояние от верха, при котором кнопка появляется
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return tamingselect; });
...
function slider() {
  if (document.querySelector('.slider-modules')) {
    var swiperModules = new _libs_swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_0___default.a('.slider-modules', {
      // spaceBetween: 24,
      loopedSlides: 1,
      autoHeight: false,
      navigation: {
